    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(news !=null){
            ...
            BeanUtils.copyProperties( news , view );//把实体数据重构到view中
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(news.getYonghuId());
                if(yonghu != null){
...
//                            newsEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
