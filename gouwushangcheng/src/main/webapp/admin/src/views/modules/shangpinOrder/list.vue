                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gouwushangcheng/upload/shangpinOrderMuBan.xls"
                        >批量导入商品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
                                style="display: inline-block"
                                action="gouwushangcheng/file/upload"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 3 && sessionTable=='shangjia' && userId==scope.row.shangpinShangjiaId" type="primary" icon="el-icon-reading" size="mini" @click="deliver(scope.row.id)">发货</el-button>
