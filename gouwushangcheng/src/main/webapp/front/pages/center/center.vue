    ...
    <view class="content">
        ...
        <view class="list">
              ...
              <view  @tap="onPageTap('../recharge/recharge')"
                     :style='{"backgroundColor":"#fff","borderColor":"#E57498","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 0 60rpx"}'
                     class="li" hover-class="hover">
                  <view class="text" :style='{"color":"#E57498","fontSize":"28rpx"}'>用户充值</view>
                  <!-- <image class="to" :style='{"color":"#E57498","fontSize":"28rpx"}' src="/static/center/to.png"></image> -->
                  <view class="cuIcon-right" :style='{"color":"#E57498","fontSize":"28rpx"}'></view>
              </view>
